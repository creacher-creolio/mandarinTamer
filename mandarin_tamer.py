...
class ToTwTradConverter(ScriptConverter):
    ...
    def __init__(
        ...
        self.taiwanization = taiwanization
...
def convert_mandarin_script(
    ...
    if target_script == "tw_traditional":
        return ToTwTradConverter(include_dicts, exclude_lists, modernize, normalize, taiwanization).convert(
